...
The frontend is built with React and Vite, deployed on Vercel with automatic CI/CD from the GitHub repository.`,
    ...
    screenshots: [
      ...
      '/screenshots/serai-02-mobile-chatbot.png',
      '/screenshots/serai-03-chatbot-open.png',
      '/screenshots/serai-04-room-selection.png',
      '/screenshots/serai-05-dates.png',
      '/screenshots/serai-06-addons.png',
      '/screenshots/serai-07-guest-info.png',
      '/screenshots/serai-08-review.png',
      '/screenshots/serai-09-added-to-cart.png',
      '/screenshots/serai-10-checkout.png',
      '/screenshots/serai-11-booking-confirmed.png',
      '/screenshots/serai-12-my-booking.png',
    ],
  },
]
