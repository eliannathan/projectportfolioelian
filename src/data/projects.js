...
The frontend is built with React and Vite, deployed on Vercel with automatic CI/CD from the GitHub repository.`,
    ...
    screenshots: [
      '/screenshots/serai-01-hero.png',
      '/screenshots/serai-02-chatbot-open.png',
      '/screenshots/serai-03-room-selection.png',
      '/screenshots/serai-04-dates.png',
      '/screenshots/serai-05-addons.png',
      '/screenshots/serai-06-guest-info.png',
      '/screenshots/serai-07-review.png',
      '/screenshots/serai-08-added-to-cart.png',
      '/screenshots/serai-09-checkout.png',
      '/screenshots/serai-10-booking-confirmed.png',
      '/screenshots/serai-11-my-booking.png',
      '/screenshots/serai-12-mobile-chatbot.png',
    ],
  },
]
